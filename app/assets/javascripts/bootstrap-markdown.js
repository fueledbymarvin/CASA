...
!function ($) {
  ...
  , showPreview: function() {
      ...
      if (typeof callbackContent == 'string') {
        ...
        // Set the content
        content = (typeof markdown == 'object') ? markdown.makeHtml(container.val()) : container.val()
      }
        ...
        if (isHideable) {
          ...
          if (editable.el != null) {
            ...
            var oldElement = $('<'+editable.type+'/>'),
                ...
                currentContent = (typeof markdown == 'object') ? markdown.makeHtml(content) : content 
